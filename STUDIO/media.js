window.MEDIA = (function () {
    ...
    function load(item) {
        ...
        // there's never a user gesture to rely on — without this line,
        // player.play() below throws NotAllowedError on every single item,
        // every time, which used to trigger fail("AUTOPLAY") in a loop.
        player.muted = true;
