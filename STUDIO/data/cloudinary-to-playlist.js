  ...
  for (const file of files) {
    ...
    try {
      const result = await cloudinary.uploader.upload(fullPath, {
        resource_type: 'video',
        tags: [TAG],
        // Force-transcode everything to mp4 on ingest. Cloudinary will
        // otherwise happily store and serve back a .mov/.m4v as-is, and
        // most browsers can't play those natively in a <video> tag --
        // they silently fail (onerror) and the on-air player skips them.
        // This guarantees every secure_url written to playlist.json is
        // an actual browser-playable .mp4, no matter what got dropped
        // into the clips folder.
        format: 'mp4',
      });
